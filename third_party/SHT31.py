...
class SHT31(object):
    ...
    # storing the specific command for different repeatability and
    ...
    def __init__(self, i2c, addr=0x44):
        ...
        self._i2c = i2c
        self._addr = addr
        self.reset() #Reset the sensor on each initialization
    ...
    def _recv(self, count):
        """
        Read bytes from the sensor using I2C.
        The byte count can be specified as an argument.
    ...
    def get_temp_humi(self, resolution=R_HIGH, clock_stretch=True, celsius=True):
        """
        Read the temperature in celsius or fahrenheit and relative humidity.
        Resolution and clock stretching can be specified.
        Returns a tuple for both values in that order.
        """
